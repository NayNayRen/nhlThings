                            ...
                            <ul>
                                @if (count($gameMatchup["matchup"]["gameInfo"]["awayTeam"]["scratches"]) > 0)
                                    @foreach ($gameMatchup["matchup"]["gameInfo"]["awayTeam"]["scratches"] as $scratchedPlayer)
                                        <li>
                                            <p>
                                                <a href="{{ route("players.player", $scratchedPlayer["id"]) }}"
                                                    target="_blank">
                                                    {{ $scratchedPlayer["firstName"]["default"] }}
                                                    {{ $scratchedPlayer["lastName"]["default"] }}
                                                </a>
                                            </p>
                                        </li>
                                    @endforeach
                ...
                <div class="game-matchup-main-container">
                    ...
                    <ul class="game-matchup-main-container-team-leaders">
                        <li>
                            ...
                            <div>
                                <p>{{ $gameMatchup["matchup"]["teamLeadersL5"][0]["awayLeader"]["name"]["default"] }}
                                </p>
                                <p></p>
                                <p>{{ $gameMatchup["matchup"]["teamLeadersL5"][0]["homeLeader"]["name"]["default"] }}
                                </p>
                            </div>
                        </li>
                        <li>
                            ...
                            <div>
                                <p>{{ $gameMatchup["matchup"]["teamLeadersL5"][1]["awayLeader"]["name"]["default"] }}
                                </p>
                                <p></p>
                                <p>{{ $gameMatchup["matchup"]["teamLeadersL5"][1]["homeLeader"]["name"]["default"] }}
                                </p>
                            </div>
                        </li>
                        <li>
                            ...
                            <div>
                                <p>{{ $gameMatchup["matchup"]["teamLeadersL5"][2]["awayLeader"]["name"]["default"] }}
                                </p>
                                <p></p>
                                <p>{{ $gameMatchup["matchup"]["teamLeadersL5"][2]["homeLeader"]["name"]["default"] }}
                                </p>
                            </div>
                        </li>
                        <li>
                            ...
                            <div>
                                <p>{{ $gameMatchup["matchup"]["teamLeadersL5"][3]["awayLeader"]["name"]["default"] }}
                                </p>
                                <p></p>
                                <p>{{ $gameMatchup["matchup"]["teamLeadersL5"][3]["homeLeader"]["name"]["default"] }}
                                </p>
                            </div>
                        </li>
                    </ul>
                        ...
                        <div class="game-matchup-away-last-ten">
                            <ul class="team-last-ten-record">
                                <li>
                                    ...
                                    <p>
                                        Streak :
                                        {{ $gameMatchup["matchup"]["last10Record"]["awayTeam"]["streakType"] }} -
                        ...
                        <div class="game-matchup-home-last-ten">
                            <ul class="team-last-ten-record">
                                <li>
                                    ...
                                    <p>
                                        Streak :
                                        {{ $gameMatchup["matchup"]["last10Record"]["homeTeam"]["streakType"] }} -
